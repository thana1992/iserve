...
@Data
@DbTable(name="jebo")
public class JeboJebdJebof implements FieldSet, java.io.Serializable {
	...
	//JEBD
	@DbColumn(name="confirmno", type=java.sql.Types.DECIMAL)
	private java.math.BigDecimal confirmno;
	
	@DbColumn(name="confirmtime", type=java.sql.Types.TIME)
	private java.sql.Time confirmtime;
	
	//JEBOF
	@DbColumn(name="orderno", type=java.sql.Types.VARCHAR)
	private String orderno;
	
	@DbColumn(name="trdno", type=java.sql.Types.INTEGER)
	private int trdno;
	
	@DbColumn(name="instrumenttype", type=java.sql.Types.VARCHAR)
	private String instrumenttype;
	
	@JsonFormat(shape = JsonFormat.Shape.STRING, pattern="yyyy-MM-dd'T'HH:mm:ss'Z'")
	@DbColumn(name="asofdate", type=java.sql.Types.DATE)
	private java.sql.Date asofdate;

	@DbColumn(name="asoftime", type=java.sql.Types.TIME)
	private java.sql.Time asoftime;
	
	@DbColumn(name="invtype", type=java.sql.Types.VARCHAR)
	private String invtype;
	
	@DbColumn(name="orgaccount", type=java.sql.Types.VARCHAR)
	private String orgaccount;
	
	@DbColumn(name="trdparti", type=java.sql.Types.VARCHAR)
	private String trdparti;

	@DbColumn(name="trdaccount", type=java.sql.Types.VARCHAR)
